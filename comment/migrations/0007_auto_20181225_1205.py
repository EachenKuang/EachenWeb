...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('comment', '0006_auto_20181224_1946'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='comment',
            name='parent',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reply_comment', to='comment.Comment'),
        ),
        migrations.AlterField(
            model_name='comment',
            name='reply_to',
