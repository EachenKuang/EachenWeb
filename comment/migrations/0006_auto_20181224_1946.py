# Generated by Django 2.1.4 on 2018-12-24 11:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('comment', '0005_auto_20181224_1938'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='comment',
            name='parent',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='reply_comment', to='comment.Comment'),
        ),
        migrations.AlterField(
            model_name='comment',
            name='user',
